...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-CeVO96zk.css',
        [],
        oscar_shop_asset_version('assets/index-CeVO96zk.css')
    );
...
wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-D1seNNMG.js',
        [],
        null,
        true
    );
