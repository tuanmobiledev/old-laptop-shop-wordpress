...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index--SQvYyOL.css',
        [],
        oscar_shop_asset_version('assets/index--SQvYyOL.css')
    );
...
wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-BtnFX8JG.js',
        [],
        null,
        true
    );
