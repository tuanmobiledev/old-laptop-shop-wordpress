...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-CZpwf87k.css',
        [],
        oscar_shop_asset_version('assets/index-CZpwf87k.css')
    );
    // Boss 2026-08-04 Bug #6/#7 root cause: NO `?ver=` here.
    // Vite puts content hash in filename (index-Df_KB6Vr.js), so URL is already
...
wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-Df_KB6Vr.js',
        [],
        null,
        true
    );
