...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-Cw-5KQTG.css',
        [],
        oscar_shop_asset_version('assets/index-Cw-5KQTG.css')
    );
...
wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-BhODTxov.js',
        [],
        null,
        true
    );
