...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-BHSKBYvU.css',
        [],
        oscar_shop_asset_version('assets/index-BHSKBYvU.css')
    );
...
wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-RSTjT-sS.js',
        [],
        null,
        true
    );
