...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-D6zusgi5.css',
        [],
        oscar_shop_asset_version('assets/index-D6zusgi5.css')
    );
...
wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-BBhICgd1.js',
        [],
        null,
        true
    );
