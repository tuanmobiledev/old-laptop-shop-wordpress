...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-Qxwmm9Ej.css',
        [],
        oscar_shop_asset_version('assets/index-Qxwmm9Ej.css')
    );
    ...
    wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-DVPq_G91.js',
        [],
        null,
        true
    );
