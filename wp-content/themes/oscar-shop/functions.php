...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-C2Re4C_E.css',
        [],
        oscar_shop_asset_version('assets/index-C2Re4C_E.css')
    );
    ...
    wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-BrFr-Jfi.js',
        [],
        null,
        true
    );
