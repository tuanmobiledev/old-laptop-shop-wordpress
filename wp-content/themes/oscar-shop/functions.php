...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-BguN4Kvr.css',
        [],
        oscar_shop_asset_version('assets/index-BguN4Kvr.css')
    );
...
wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-CGFprqBB.js',
        [],
        null,
        true
    );
