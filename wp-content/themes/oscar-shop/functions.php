...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-B5pxCUQI.css',
        [],
        oscar_shop_asset_version('assets/index-B5pxCUQI.css')
    );
...
wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-kr0tlsIN.js',
        [],
        null,
        true
    );
