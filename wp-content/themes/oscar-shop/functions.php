...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-0cD5AXlh.css',
        [],
        oscar_shop_asset_version('assets/index-0cD5AXlh.css')
    );
...
wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-DtIcTEtq.js',
        [],
        null,
        true
    );
