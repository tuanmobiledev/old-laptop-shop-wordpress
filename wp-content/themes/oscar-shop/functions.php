...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-E_lEzo2o.css',
        [],
        oscar_shop_asset_version('assets/index-E_lEzo2o.css')
    );
...
wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-5E5OKBEP.js',
        [],
        null,
        true
    );
