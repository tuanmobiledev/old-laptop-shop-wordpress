...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-D9zKbZWX.css',
        [],
        oscar_shop_asset_version('assets/index-D9zKbZWX.css')
    );
...
wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-DwNDL3EK.js',
        [],
        null,
        true
    );
