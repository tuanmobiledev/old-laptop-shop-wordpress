...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-DMSd-vfO.css',
        [],
        oscar_shop_asset_version('assets/index-DMSd-vfO.css')
    );
...
wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-pu8nb0CH.js',
        [],
        null,
        true
    );
