...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-D51cNr3B.css',
        [],
        oscar_shop_asset_version('assets/index-D51cNr3B.css')
    );
...
wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-DVycUl6e.js',
        [],
        null,
        true
    );
