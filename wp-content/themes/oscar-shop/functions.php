...
function oscar_shop_enqueue_assets(): void
{
    ...
    wp_enqueue_style(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-B6fwyZnQ.css',
        [],
        oscar_shop_asset_version('assets/index-B6fwyZnQ.css')
    );
...
wp_enqueue_script(
        'oscar-storefront',
        get_template_directory_uri() . '/assets/index-Bb88VJwY.js',
        [],
        null,
        true
    );
